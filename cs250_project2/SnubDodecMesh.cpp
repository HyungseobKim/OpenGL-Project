...
int SnubDodecMesh::VertexCount(void) { return 60; }
Point SnubDodecMesh::GetVertex(int i) { return vertices[i]; }
Vector SnubDodecMesh::Dimensions(void) { return Vector(2, 2, 2); }
Point SnubDodecMesh::Center(void) { return Point(0, 0, 0); }
int SnubDodecMesh::FaceCount(void) { return 116; }
Mesh::Face SnubDodecMesh::GetFace(int i) { return faces[i]; }
int SnubDodecMesh::EdgeCount(void) { return 150; }
Mesh::Edge SnubDodecMesh::GetEdge(int i) { return edges[i]; }
...
int SnubDodecMesh::GetType()
{
	return 1;
}

const Point* SnubDodecMesh::GetVertices()
{
	return vertices;
}

const SnubDodecMesh::Face* SnubDodecMesh::GetIndices()
{
	return faces;
}

const Vector* SnubDodecMesh::GetNormal()
{
	return normal;
}